          ...
          Expanded(
            child: ListView(
              ...
              children: <Widget>[
                ...
                FloatingActionButton.extended(
                  onPressed: () async {
                    TextStyle datesStyle = GoogleFonts.josefinSans(
                      fontSize: 13,
                      letterSpacing: 1,
                    ...
                    DateTime newDateTime = await showRoundedDatePicker(
                      ...
                      styleDatePicker: MaterialRoundedDatePickerStyle(
                        textStyleMonthYearHeader: GoogleFonts.josefinSans(
                          fontSize: 15,
                          // letterSpacing: 1,
                          color: Color(0xFF333333),
                          fontWeight: FontWeight.w700,
                        ),
                        selectDateText: GoogleFonts.josefinSans(
                          fontSize: 10,
                          letterSpacing: 1,
                          fontWeight: FontWeight.w700,
                          color: Color(0xFF333333),
                        ),
                        textStyleYearButton: GoogleFonts.josefinSans(
                          fontSize: 16,
                          // letterSpacing: 1,
                          fontWeight: FontWeight.w800,
                          color: Color(0xFF333333),
                        ),
                        textStyleDayButton: GoogleFonts.josefinSans(
                          fontSize: 21,
                          letterSpacing: 1,
                          fontWeight: FontWeight.w800,
                          color: Color(0xFF333333),
                        ),
                        textStyleButtonSubmit: GoogleFonts.josefinSans(
                          fontSize: 16,
                          letterSpacing: 1,
                          fontWeight: FontWeight.w700,
                          color: Colors.white,
                        ),
                        textStyleCurrentDayOnCalendar: datesStyle,
                        textStyleDayOnCalendar: datesStyle,
                        textStyleDayHeader: GoogleFonts.josefinSans(
                          fontSize: 10,
                          letterSpacing: 1,
                          fontWeight: FontWeight.w800,
                          color: Color(0xFF888787),
                        ),
                        textStyleDayOnCalendarDisabled: datesStyle,
                        submitButtonBackground: Color(0xFFE84F77),
                        decorationDateSelected: BoxDecoration(
                          color: Colors.transparent,
                          border: Border.all(color: Color(0xFFE84F77), width: 2),
                          shape: BoxShape.circle,
                        ),
                        textStyleDayOnCalendarSelected: datesStyle,
                      ),
                      theme: ThemeData(
                        primaryColor: Color(0xFFEEEEEE),
                        accentColor: Color(0xFFE84F77),
                        textTheme: TextTheme(
                          caption: TextStyle(color: Color(0xFF888787)),
                        ),
